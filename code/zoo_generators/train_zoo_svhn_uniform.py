...
def main():
    ...
    # experiment name
    project = "SVHN Uniform"
    experiment_name = "tune_zoo_svhn_uniform"
    ...
    try:
        ...
        val_and_trainset_raw = datasets.SVHN(
            svhn_path, split="train", download=True, transform=transform)
        testset_raw = datasets.SVHN(
            svhn_path, split="test", download=True, transform=transform)
