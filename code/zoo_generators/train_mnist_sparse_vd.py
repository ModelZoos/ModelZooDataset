...
def main():
    ...
    # experiment name
    project = "cnn_small_mnist_ard"
    experiment_name = "cnn_small_mnist_ard"

    source_zoo_path = Path('./zoos/MNIST/tune_zoo_mnist_uniform/')
    ...
    net_dir = PATH_ROOT.joinpath("zoos/MNIST/ARD")
    try:
...
d        json.dump(config, f, default=str)
