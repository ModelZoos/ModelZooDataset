...
def main():
    ...
    # experiment name
    project = "CIFAR10 Uniform Small"
    experiment_name = "tune_zoo_cifar10_uniform_small"
    ...
    net_dir = PATH_ROOT.joinpath("zoos/CIFAR10/small")
    try:
    ...
    try:
        ...
        dataset = torch.load(str(cifar_path.joinpath("dataset_28px.pt")))
