...
def main():
    ...
    # experiment name
    project = "CIFAR100 Resnet18 kaiming-uniform"
    experiment_name = "tune_zoo_cifar100_resnet18_kaiming_uniform"

    # set module parameters
    config = {}
    config["model::type"] = "Resnet18"
    config["model::channels_in"] = 3
    config["model::o_dim"] = 100
    ...
    net_dir = PATH_ROOT.joinpath("zoos/CIFAR100/resnet18/kaiming_uniform")
    try:
    ...
    cifar_path = PATH_ROOT.joinpath("data/CIFAR100")
    ...
    val_and_trainset = datasets.CIFAR100(
        root="./data/CIFAR100", train=True, transform=train_transforms, download=True
    )

    testset = datasets.CIFAR100(
        root="./data/CIFAR100", train=False, transform=test_transforms, download=True
    )
