...
def main():
    ...
    # experiment name
    project = "Corr: STL Random Small"
    experiment_name = "tune_zoo_stl_small_hyperparameter_10_random_seeds"
    ...
    net_dir = PATH_ROOT.joinpath("zoos/STL-10/small")
    try:
    ...
    try:
        ...
        dataset = torch.load(str(stl_path.joinpath("dataset_28px.pt")))
        ...
        torch.save(dataset, stl_path.joinpath("dataset_28px.pt"))
